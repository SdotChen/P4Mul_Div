    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    Register<bit<32>,bit<1>>(1) reg_quotient;
    RegisterAction<bit<32>,bit<1>,bit<1>>(reg_quotient) _save_quotient = {
    ...
    Register<bit<32>,bit<1>>(1) reg_remainder;
    RegisterAction<bit<32>,bit<1>,bit<1>>(reg_remainder) _save_remainder = {
        void apply(inout bit<32> reg_data) {
